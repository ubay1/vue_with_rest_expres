		...
		<div class="homepage-header-background">
			<div class="container-fluid">
				...
				<div class="bg-add-product">
					...
					<button data-toggle="modal" data-target="#addproduct" class="btn btn-primary btn-add">Tambah Product</button>
					<br><br>
				</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form @submit.prevent="addProduct()" method="post">
									<input type="text" class="form-control form-addproduct" v-model="form.nama" name="nama"
										placeholder="masukan nama product"> <br>

									<input type="text" class="form-control form-addproduct" v-model="form.price" name="price"
										placeholder="masukan harga product"> <br>

									<button type="submit" :disabled="btnsubmit" class="btn btn-primary form-addproduct">Simpan <img
				...
				<div class="bg-apiblog row ">
					<div v-for="(product, index) in products" :key="index"
						class="data-product col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="card" style="width:100%">
							...
							<div class="card-footer bg-footer">
								...
								<div style="display:flex; justify-content:right;">
									<button @click="showModalEdit(product.id,product.nama, product.price)" style="border-radius:0px;"
										type="button" class="btn btn-warning btn-sm" :value="product.id">Edit</button>

									<button style="border-radius:0px;" @click.prevent="deleteProduct(product.id)" type="button"
										class="btn btn-danger btn-sm" :value="product.id">Hapus</button>
								</div>
							</div>
						</div>
					</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			deleteProduct(id) {
				var r = confirm('Yakin ingin hapus ? data yang dihapus tidak dapat kembali lagi ..');
				if(r == true){
